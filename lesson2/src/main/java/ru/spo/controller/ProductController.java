...
import ru.spo.servise.ProductServiseImpl;
...
public class ProductController {
    ...
    private final ProductServiseImpl productService;

    public ProductController(ProductServiseImpl productService) {
    ...
    //http://localhost:8080/app/products/delete/1
